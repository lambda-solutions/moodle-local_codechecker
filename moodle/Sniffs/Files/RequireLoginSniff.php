...
class moodle_Sniffs_Files_RequireLoginSniff implements PHP_CodeSniffer_Sniff {
    protected $loginfunctions = ['require_login', 'require_course_login', 'admin_externalpage_setup'];
    protected $ignorewhendefined = ['NO_MOODLE_COOKIES', 'CLI_SCRIPT', 'ABORT_AFTER_CONFIG'];
    /**
